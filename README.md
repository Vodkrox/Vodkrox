...
<p>
  <img src="https://skillicons.dev/icons?i=linux,python,bash,windows,nodejs,html,css,javascript,react,mysql,git,typescript,cs,vscode,docker,arduino,powershell,ps,debian,arch,kali,cmake,discord,dotnet,electron,eclipse,figma,gcp,github,gtk,neovim,nextjs,notion,npm,obsidian,raspberrypi,sqlite,sketchup,svg,unity,vim,qt" />
</p>
...
<img src="assets/archived.svg" width="12"> **ORION**: A subscription-based SaaS platform that provides on-demand Minecraft servers. I manage maintenance, moderation, and the installation or removal of mods (game modifications). It has **28 subscribers** and has been active since **April 30, 2026**.
