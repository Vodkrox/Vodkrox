...
<img src="assets/active.svg" width="12"> Lithium: I am currently working on **Lithium**, a **minimalist AI-powered code editor** designed to run **entirely locally**. The project focuses on providing intelligent coding assistance while keeping all processing on the user's machine, ensuring privacy, low latency, and offline usability. 


<img src="assets/active.svg" width="12"> Orion: I am also working on **Orion**, a subscription-based SaaS platform that provides on-demand Minecraft servers. I manage maintenance, moderation, and the installation or removal of mods (game modifications). It is currently active and has **28 subscribers**.
